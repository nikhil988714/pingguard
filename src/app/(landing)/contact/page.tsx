      ...
      <div className="container mx-auto max-w-6xl px-4 pt-20 pb-32">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Have questions about PingGuard? We're here to help you get the most out of your website monitoring.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-white/70 mb-8">
                Reach out to our team for support, sales inquiries, or any questions about 
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70">support@pingguard.com</p>
