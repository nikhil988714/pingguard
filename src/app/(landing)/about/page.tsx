        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          <div>
            ...
            <div className="space-y-4 text-white/70 leading-relaxed">
              <p>
                PingGuard was born from frustration. As developers, we were tired of complex, expensive monitoring solutions
              ...
              <p>
                ...
                provided instant alerts, and didn't break the bank. Today, PingGuard monitors over 10,000 websites worldwide
        ...
        <div className="text-center">
          <div className="bg-white/5 rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-white/70 mb-6 max-w-2xl mx-auto">
              Ready to experience simple, reliable website monitoring? Start your free trial today and see why thousands of developers choose PingGuard.
            </p>
