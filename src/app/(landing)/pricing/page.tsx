      ...
      <div className="container mx-auto max-w-7xl px-4 pt-20 pb-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20 px-4 sm:px-0">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`relative bg-white/5 rounded-2xl p-6 sm:p-8 border ${plan.popular
            ...
            >
              ...
              <Button
                className={`w-full rounded-lg font-semibold py-3 transition-all duration-300 text-sm sm:text-base ${plan.popular
