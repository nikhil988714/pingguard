  ...
  const testimonials = [
    {
      ...
      content: "PingGuard has been a game-changer for our monitoring needs. The instant alerts have saved us countless hours.",
      rating: 5
    },
    {
      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Join thousands of developers and businesses who trust PingGuard to keep their websites online.
